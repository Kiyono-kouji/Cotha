...
<section style="overflow: hidden; position: relative;">
    ...
    <div class="container position-relative" style="z-index: 2; margin-top: -250px; margin-bottom: 80px;">
                ...
                <div class="card shadow-lg border-0 rounded-4 p-4" style="background: rgba(255,255,255,0.98);">
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" id="email" class="form-control rounded-3 border-2" style="border-color: #4fc3f7;" required autofocus value="{{ old('email') }}">
                            @error('email')
                                <span class="text-danger small">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="d-grid mb-3">
                            <button type="submit" class="btn btn-lg fw-semibold rounded-3 shadow"
