            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-12 col-lg-8 text-white pt-5 mt-5 text-center" style="margin-top: 6rem !important;">
                    ...
                    <p class="fs-5 mb-4" style="font-size: 1.1rem; text-shadow: 1px 1px 2px rgba(0,0,0,0.12); max-width: 600px; margin: 0 auto;">
                        Fill in the details below to create a new class for COTHA.
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <form method="POST" action="{{ route('admin.classes.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" name="level" class="form-control rounded-3 border-2" style="border-color: #4fc3f7;" required value="{{ old('level') }}">
                            </div>
                            <div class="col-12 col-md-6">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" name="meeting_info" class="form-control rounded-3 border-2" style="border-color: #4fc3f7;" value="{{ old('meeting_info') }}">
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" name="note" class="form-control rounded-3 border-2" style="border-color: #4fc3f7;" value="{{ old('note') }}">
                            </div>
                            <div class="col-12 col-md-6">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="button_link" class="form-control rounded-3 border-2" style="border-color: #4fc3f7;" value="{{ old('button_link') }}">
                            </div>
