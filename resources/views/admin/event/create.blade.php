            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-12 col-lg-8 text-white pt-5 mt-5 text-center" style="margin-top: 6rem !important;">
                    ...
                    <p class="fs-5 mb-4" style="font-size: 1.1rem; text-shadow: 1px 1px 2px rgba(0,0,0,0.12); max-width: 600px; margin: 0 auto;">
                        Fill in the details below to create a new event for COTHA.
                    </p>
                </div>
            </div>
        </div>
            ...
            <form action="{{ route('admin.events.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <select name="registration_type" class="form-select rounded-3 border-2" style="border-color: #4fc3f7;" required>
                        ...
                        <option value="team" {{ old('registration_type') == 'team' ? 'selected' : '' }}>Team</option>
                    </select>
                </div>
                <div class="mb-3" id="maxTeamMembersWrapper" style="display: none;">
                    <label class="form-label fw-semibold">Max Team Members</label>
                    <input type="number" name="max_team_members" class="form-control rounded-3 border-2" style="border-color: #4fc3f7;" min="2" max="20" value="{{ old('max_team_members') }}">
                </div>
                <div class="mb-3">
                    <label class="form-label fw-semibold">Price per Participant (Rp) <span class="text-danger">*</span></label>
                    <input type="number" name="price_per_participant" class="form-control rounded-3 border-2" style="border-color: #4fc3f7;" min="0" value="{{ old('price_per_participant', 0) }}" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="datetime-local" name="date" class="form-control rounded-3 border-2" style="border-color: #4fc3f7;" value="{{ old('date') }}" required>
                </div>
                <div class="mb-3">
                    <label class="form-label fw-semibold">Last Registration Date & Time</label>
                    <input type="datetime-local" name="last_registration_at" class="form-control rounded-3 border-2" style="border-color: #4fc3f7;" value="{{ old('last_registration_at') }}">
                </div>
                <div class="mb-3">
                    <label class="form-label fw-semibold">Location</label>
                    <input type="text" name="location" class="form-control rounded-3 border-2" style="border-color: #4fc3f7;" value="{{ old('location') }}">
                </div>
                <div class="mb-3">
