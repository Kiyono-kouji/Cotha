                    ...
                    <form method="POST" action="{{ route('admin.partners.update', $partner->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" name="name" class="form-control rounded-3 border-2" style="border-color: #4fc3f7;" required value="{{ old('name', $partner->name) }}">
                            </div>
                            <div class="col-12">
                                <label class="form-label fw-semibold" style="color:#2C3E50;">Logo</label>
                                @if($partner->logo)
                                    <div class="mb-2">
                                        <img src="{{ asset('storage/' . $partner->logo) }}" alt="{{ $partner->name }}" style="height: 80px; max-width: 180px; object-fit: contain;">
                                    </div>
                                @endif
                                <input type="file" name="logo" class="form-control rounded-3 border-2" style="border-color: #4fc3f7;" accept="image/*">
                        ...
                        <div class="text-center mt-4">
                            ...
                            <a href="{{ route('admin.partners.index') }}" class="btn btn-lg px-5 py-3 fw-semibold rounded-3 shadow ms-2"
