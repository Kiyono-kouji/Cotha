...
<section style="overflow: hidden; position: relative;">
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-12 col-lg-6 text-white pt-5 mt-5 text-lg-start text-center ps-lg-5" style="margin-top: 6rem !important;">
                    ...
                    <p class="fs-5 mb-4" style="font-size: 1.1rem; text-shadow: 1px 1px 2px rgba(0,0,0,0.12); max-width: 520px;">
                        Add, edit, and organize all partners at COTHA.
                    </p>
                </div>
    ...
    <div class="container py-5 position-relative" style="z-index: 2;">
        {{-- Search and Add New Partner Row --}}
        <div class="row align-items-center mb-4">
            <div class="col-12 col-md-7">
                <form method="GET" action="{{ route('admin.partners.index') }}" class="d-flex gap-2 align-items-center">
                    <input type="text"
                           name="search"
        ...
        @if ($partners->hasPages())
            <div class="text-center mt-5">
                <p class="text-muted mb-3">
                    Page {{ $partners->currentPage() }} of {{ $partners->lastPage() }}
                </p>
                <nav aria-label="Page navigation">
                    <ul class="pagination justify-content-center" style="gap: 8px;">
                        ...
                        @else
                            <li class="page-item">
                                <a class="page-link border-0 shadow-sm"
                                   ...
                                   href="{{ $partners->previousPageUrl() }}" rel="prev">
                                    <i class="bi bi-chevron-left"></i>
                                </a>
                            </li>
                        @endif
                        ...
                        @foreach ($display as $item)
                            ...
                            @else
                                @php $url = $partners->url($item); @endphp
                                @if ($item == $current)
                        ...
                        @if ($partners->hasMorePages())
                            <li class="page-item">
                                <a class="page-link border-0 shadow-sm"
                                   style="background: #FF85A2; color: #fff; border-radius: 12px;"
                                   href="{{ $partners->nextPageUrl() }}" rel="next">
