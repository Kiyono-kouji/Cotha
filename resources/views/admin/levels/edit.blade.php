            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-12 col-lg-8 text-white pt-5 mt-5 text-center" style="margin-top: 6rem !important;">
                    ...
                    <p class="fs-5 mb-4" style="font-size: 1.1rem; text-shadow: 1px 1px 2px rgba(0,0,0,0.12); max-width: 600px; margin: 0 auto;">
                        Update the details for this learning level.
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <form method="POST" action="{{ route('admin.levels.update', $level->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" name="title" class="form-control rounded-3 border-2" style="border-color: #4fc3f7;" required value="{{ old('title', $level->title) }}">
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label fw-semibold" style="color:#2C3E50;">Subtitle</label>
                                <input type="text" name="subtitle" class="form-control rounded-3 border-2" style="border-color: #4fc3f7;" value="{{ old('subtitle', $level->subtitle) }}">
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label fw-semibold" style="color:#2C3E50;">Age Range</label>
                                <input type="text" name="age_range" class="form-control rounded-3 border-2" style="border-color: #4fc3f7;" value="{{ old('age_range', $level->age_range) }}">
                            </div>
                            <div class="col-12">
                                <label class="form-label fw-semibold" style="color:#2C3E50;">Description</label>
                                <textarea name="description" class="form-control rounded-3 border-2" rows="3" style="border-color: #4fc3f7;">{{ old('description', $level->description) }}</textarea>
                            </div>
                            <div class="col-12 col-md-6">
