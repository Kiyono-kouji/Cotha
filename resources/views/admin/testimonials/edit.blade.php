...
<div class="container my-5">
    ...
    <form method="POST" action="{{ route('admin.testimonials.update', $testimonial->id) }}" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="school" class="form-control" value="{{ old('school', $testimonial->school) }}">
        </div>
        <div class="mb-3">
            <label class="form-label fw-semibold">City</label>
            <input type="text" name="city" class="form-control" value="{{ old('city', $testimonial->city) }}">
        </div>
