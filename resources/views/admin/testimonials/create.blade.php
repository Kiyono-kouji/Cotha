            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-12 col-lg-8 text-white pt-5 mt-5 text-center" style="margin-top: 6rem !important;">
                    ...
                    <p class="fs-5 mb-4" style="font-size: 1.1rem; text-shadow: 1px 1px 2px rgba(0,0,0,0.12); max-width: 600px; margin: 0 auto;">
                        Fill in the details below to add a new testimonial from a student.
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <form method="POST" action="{{ route('admin.testimonials.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" name="name" class="form-control rounded-3 border-2" style="border-color: #4fc3f7;" required value="{{ old('name') }}">
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" name="school" class="form-control rounded-3 border-2" style="border-color: #4fc3f7;" value="{{ old('school') }}">
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label fw-semibold" style="color:#2C3E50;">City</label>
                                <input type="text" name="city" class="form-control rounded-3 border-2" style="border-color: #4fc3f7;" value="{{ old('city') }}">
                            </div>
                            <div class="col-12">
                                <label class="form-label fw-semibold" style="color:#2C3E50;">Testimonial Text <span class="text-danger">*</span></label>
                                <textarea name="text" class="form-control rounded-3 border-2" rows="4" style="border-color: #4fc3f7;" required>{{ old('text') }}</textarea>
                            </div>
