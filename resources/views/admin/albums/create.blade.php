            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-12 col-lg-8 text-white pt-5 mt-5 text-center" style="margin-top: 6rem !important;">
                    ...
                    <p class="fs-5 mb-4" style="font-size: 1.1rem; text-shadow: 1px 1px 2px rgba(0,0,0,0.12); max-width: 600px; margin: 0 auto;">
                        Fill in the details below to create a new gallery and add media for COTHA.
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <form method="POST" action="{{ route('admin.albums.store') }}" enctype="multipart/form-data" id="albumForm">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" name="title" class="form-control rounded-3 border-2 w-100" style="border-color: #4fc3f7;" required value="{{ old('title') }}">
                            </div>
                            <div class="col-12">
                                <label class="form-label fw-semibold" style="color:#2C3E50;">Partners</label>
                                <select name="partners[]" class="form-select rounded-3 border-2 w-100" multiple style="border-color: #4fc3f7;">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description" class="form-control rounded-3 border-2 w-100" rows="3" style="border-color: #4fc3f7;">{{ old('description') }}</textarea>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="text-center mt-4 d-flex flex-column flex-md-row align-items-center justify-content-center gap-3">
                            <button type="submit" class="btn btn-lg px-5 py-3 fw-semibold rounded-3 shadow"
                                ...
                                <i class="bi bi-save me-2"></i>Save Gallery & Media
                            </button>
