        ...
        <div class="card shadow-lg border-0 rounded-4 p-4" style="background: rgba(255,255,255,0.98);">
            <form method="POST" action="{{ route('admin.articles.store') }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="headline" class="form-control rounded-3 border-2" required value="{{ old('headline') }}">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="body" class="form-control rounded-3 border-2" rows="6" required>{{ old('body') }}</textarea>
                </div>
