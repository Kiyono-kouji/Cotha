            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-12 col-lg-8 text-white pt-5 mt-5 text-center" style="margin-top: 6rem !important;">
                    ...
                    <p class="fs-5 mb-4" style="font-size: 1.1rem; text-shadow: 1px 1px 2px rgba(0,0,0,0.12); max-width: 600px; margin: 0 auto;">
                        Update the details for this learning method.
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <form method="POST" action="{{ route('admin.methods.update', $method->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" name="title" class="form-control rounded-3 border-2" style="border-color: #4fc3f7;" required value="{{ old('title', $method->title) }}">
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label fw-semibold" style="color:#2C3E50;">Label</label>
                                <input type="text" name="label" class="form-control rounded-3 border-2" style="border-color: #4fc3f7;" value="{{ old('label', $method->label ?? '') }}">
                            </div>
                            <div class="col-12">
                                <label class="form-label fw-semibold" style="color:#2C3E50;">Description <span class="text-danger">*</span></label>
                                <textarea name="description" class="form-control rounded-3 border-2" rows="4" style="border-color: #4fc3f7;" required>{{ old('description', $method->description) }}</textarea>
                            </div>
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-check d-flex align-items-center" style="min-height: 48px;">
                                    <input type="checkbox" name="active" class="form-check-input mt-0" id="active" {{ old('active', $method->active) ? 'checked' : '' }}>
                        ...
                        <div class="text-center mt-4">
                            <button type="submit" class="btn btn-lg px-5 py-3 fw-semibold rounded-3 shadow"
                                ...
                                <i class="bi bi-save me-2"></i>Update Method
                            </button>
                            <a href="{{ route('admin.methods.index') }}" class="btn btn-lg px-5 py-3 fw-semibold rounded-3 shadow ms-2"
