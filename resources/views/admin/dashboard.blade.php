...
<section style="overflow: hidden; position: relative;">
    ...
    <div class="container py-5 position-relative" style="z-index: 2;">
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-12 col-sm-6 col-lg-4">
                <a href="{{ route('admin.event_categories.index') }}" class="card border-0 shadow h-100 text-decoration-none" style="border-radius: 20px; background: white;">
                    <div class="card-body text-center py-5 d-flex flex-column align-items-center justify-content-center h-100">
                        <div class="mb-3 d-flex align-items-center justify-content-center mx-auto"
                             style="width: 64px; height: 64px; border-radius: 50%; background: #80c7e4;">
                            <i class="bi bi-tags fs-2 text-white"></i>
                        </div>
                        <h5 class="fw-bold mb-2" style="color: #2C3E50;">Manage Event Categories</h5>
                        <p class="text-secondary mb-0">Create, edit, and organize event categories.</p>
                    </div>
                </a>
            </div>
            <div class="col-12 col-sm-6 col-lg-4">
            ...
            <div class="col-12 col-sm-6 col-lg-4">
                <a href="{{ route('admin.registrations.index') }}" class="card border-0 shadow h-100 text-decoration-none" style="border-radius: 20px; background: white;">
                    <div class="card-body text-center py-5 d-flex flex-column align-items-center justify-content-center h-100">
                        ...
                        <p class="text-secondary mb-0">Review, search, and manage all trial class registrations at COTHA.</p>
                    </div>
                </a>
            </div>
            <div class="col-12 col-sm-6 col-lg-4">
                <a href="{{ route('admin.articles.index') }}" class="card border-0 shadow h-100 text-decoration-none" style="border-radius: 20px; background: white;">
                    <div class="card-body text-center py-5 d-flex flex-column align-items-center justify-content-center h-100">
                        <div class="mb-3 d-flex align-items-center justify-content-center mx-auto"
                             style="width: 64px; height: 64px; border-radius: 50%; background: #ffb74d;">
                            <i class="bi bi-journal-text fs-2 text-white"></i>
                        </div>
                        <h5 class="fw-bold mb-2" style="color: #2C3E50;">Manage Articles</h5>
                        <p class="text-secondary mb-0">Create, edit, and organize articles or blog posts.</p>
                    </div>
                </a>
            </div>
        </div>
