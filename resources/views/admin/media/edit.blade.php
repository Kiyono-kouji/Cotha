            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-12 col-lg-8 text-white pt-5 mt-5 text-center" style="margin-top: 6rem !important;">
                    ...
                    <p class="fs-5 mb-4" style="font-size: 1.1rem; text-shadow: 1px 1px 2px rgba(0,0,0,0.12); max-width: 600px; margin: 0 auto;">
                        Update the details for this album media.
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <form method="POST" action="{{ route('admin.media.update', $media->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6 d-flex flex-column align-items-center justify-content-start">
                                ...
                                @if($media->type === 'image')
                                    <img src="{{ asset('storage/' . $media->file) }}" class="img-fluid mb-2 rounded" style="max-width:320px; max-height:320px;">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="caption" class="form-control rounded-3 border-2" style="border-color: #4fc3f7;" value="{{ old('caption', $media->caption) }}">
                            </div>
                        </div>
                        <div class="text-center mt-4">
                            ...
                            <a href="{{ route('admin.albums.show', $media->album_id) }}" class="btn btn-lg px-5 py-3 fw-semibold rounded-3 shadow ms-2"
