...
<section style="overflow: hidden; position: relative;">
    ...
    {{-- Hero Section --}}
    <div class="container-fluid py-5 position-relative" style="min-height: 380px;">
        <div style="position: absolute; inset: 0; width: 100%; height: 100%; z-index: 0;">
            ...
            <div style="position: absolute; bottom: 30px; right: 120px; width: 40px; height: 40px; border-radius: 50%; background: #4fc3f7; opacity: 0.08; z-index: 1;"></div>
        ...
        <div class="container position-relative" style="z-index: 1;">
            <div class="row align-items-center justify-content-center">
                <div class="col-12 col-lg-8 text-white pt-5 mt-5 text-center" style="margin-top: 5rem !important;">
    ...
    {{-- Form Card Overlay --}}
    <div class="container position-relative" style="z-index: 2; margin-top: -80px; margin-bottom: 80px;">
                    ...
                    <form method="POST" action="{{ route('admin.articles.update', $article->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" name="headline" class="form-control rounded-3 border-2" style="border-color: #4fc3f7;" required value="{{ old('headline', $article->headline) }}">
                            </div>
                            <div class="col-12">
                                <label class="form-label fw-semibold" style="color:#2C3E50;">Image 1</label>
                                @if($article->image1)
                                    <div class="mb-2 d-flex align-items-center gap-2">
                                        <img src="{{ asset('storage/images/Articles/' . $article->image1) }}" alt="Image 1" class="rounded" style="max-width: 200px; max-height: 200px; object-fit: cover;">
                                        <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteImage1Modal">
                            ...
                            <div class="col-12">
                                ...
                                @if($article->image2)
                                    <div class="mb-2 d-flex align-items-center gap-2">
                                        <img src="{{ asset('storage/images/Articles/' . $article->image2) }}" alt="Image 2" class="rounded" style="max-width: 200px; max-height: 200px; object-fit: cover;">
                                        <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteImage2Modal">
                                            <i class="bi bi-trash"></i> Delete
                                        </button>
                                    </div>
                                @endif
                            ...
                            <div class="col-12">
                                <label class="form-label fw-semibold" style="color:#2C3E50;">Thumbnail</label>
                                @if($article->thumbnail)
                                    <div class="mb-2 d-flex align-items-center gap-2">
                                        <img src="{{ asset('storage/images/Articles/' . $article->thumbnail) }}" alt="Thumbnail" class="rounded" style="max-width: 200px; max-height: 200px; object-fit: cover;">
                                        <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteThumbnailModal">
                                            <i class="bi bi-trash"></i> Delete
                                        </button>
                                    </div>
                                @endif
                                <input type="file" name="thumbnail" class="form-control rounded-3 border-2" style="border-color: #4fc3f7;" accept="image/*">
                                <small class="text-muted">Leave blank to keep current thumbnail. If none, Image 1 will be used.</small>
                            </div>

                            {{-- Delete All Images Button --}}
                            @if($article->image1 || $article->image2 || $article->thumbnail)
                            <div class="col-12 mt-3">
                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteAllImagesModal">
                                    <i class="bi bi-trash"></i> Delete All Images
                                </button>
                            </div>
                            @endif

                            <div class="col-12 mt-3">
                                <label class="form-label fw-semibold" style="color:#2C3E50;">Body</label>
                                <textarea name="body" rows="10" class="form-control rounded-3 border-2" style="border-color: #4fc3f7;" required>{{ old('body', $article->body) }}</textarea>
                            </div>
                            <div class="col-12">
...
{{-- Delete Image 1 Modal --}}
@if($article->image1)
<div class="modal fade" id="deleteImage1Modal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Delete Image 1</h5>
            ...
            <div class="modal-footer">
                ...
                <form action="{{ route('admin.articles.images.destroy', [$article->id, 'image1']) }}" method="POST" class="d-inline">
                    @csrf
                    @method('DELETE')
...
{{-- Delete Image 2 Modal --}}
@if($article->image2)
<div class="modal fade" id="deleteImage2Modal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Delete Image 2</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                Are you sure you want to delete this image?
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                <form action="{{ route('admin.articles.images.destroy', [$article->id, 'image2']) }}" method="POST" class="d-inline">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="btn btn-danger">Delete</button>
                </form>
...
@if($article->thumbnail)
<div class="modal fade" id="deleteThumbnailModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                <form action="{{ route('admin.articles.images.destroy', [$article->id, 'thumbnail']) }}" method="POST" class="d-inline">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="btn btn-danger">Delete</button>
                </form>
...
@if($article->image1 || $article->image2 || $article->thumbnail)
<div class="modal fade" id="deleteAllImagesModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Delete All Images</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                <form action="{{ route('admin.articles.images.destroyAll', $article->id) }}" method="POST" class="d-inline">
                    @csrf
                    @method('DELETE')
