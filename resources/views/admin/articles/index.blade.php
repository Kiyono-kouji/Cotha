            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-12 col-lg-6 text-white pt-5 mt-5 text-lg-start text-center ps-lg-5" style="margin-top: 6rem !important;">
                    ...
                    <p class="fs-5 mb-4" style="font-size: 1.1rem; text-shadow: 1px 1px 2px rgba(0,0,0,0.12); max-width: 520px;">
                        Create, edit, and organize all articles at COTHA.
                    </p>
                </div>
            ...
            <table class="table table-bordered table-striped align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            @php
                                $thumbnailSrc = $article->thumbnail 
                                    ? asset('storage/images/Articles/' . $article->thumbnail)
                                    : ($article->image1 
                                        ? asset('storage/images/Articles/' . $article->image1)
                                        : asset('images/default_project.png'));
                            @endphp
                        ...
                        <td>{{ \Illuminate\Support\Str::limit($article->body, 80) }}</td>
                        <td>
                            @if($article->active)
                        ...
                        <td>
                            <a href="{{ route('admin.articles.edit', $article->id) }}" class="btn btn-sm btn-warning rounded-pill">
